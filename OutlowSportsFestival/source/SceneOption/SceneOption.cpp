...
void SceneOption::Update()
{
    ...
    if (true)
    {
        ...
        //キャラ選択
        param.PlayerArray.at(0) = { 0, PlayerType::_Player, CharacterType::_Soccer };
        param.PlayerArray.at(1) = { 1, PlayerType::_Computer, CharacterType::_Tennis };
        param.PlayerArray.at(2) = { 2, PlayerType::_Computer, CharacterType::_Tennis };
        param.PlayerArray.at(3) = { 3, PlayerType::_Computer, CharacterType::_Tennis };
