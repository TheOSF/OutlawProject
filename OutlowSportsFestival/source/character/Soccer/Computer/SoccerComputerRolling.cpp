...
SoccerState_ComputerControll_Rolling::SoccerState_ComputerControll_Rolling(CallBackClass* pCallBackClass, bool dash) :
	m_pCallBackClass(pCallBackClass), Dash(dash)
{

}

SoccerState_ComputerControll_Rolling::~SoccerState_ComputerControll_Rolling()
{
...
// ステート開始
void SoccerState_ComputerControll_Rolling::Enter(SoccerPlayer* s)
{
	m_Timer = 0;
...
// ステート実行
void SoccerState_ComputerControll_Rolling::Execute(SoccerPlayer* s)
{
...
// ステート終了
void SoccerState_ComputerControll_Rolling::Exit(SoccerPlayer* t)
{
