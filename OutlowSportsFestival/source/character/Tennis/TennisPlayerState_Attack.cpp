...
void TennisState_PlayerControll_Attack::Enter(TennisPlayer* t)
{
    ...
    {
        { 6, 1.0f, 1.5f, DamageBase::Type::_WeekDamage,   15, 22, 0.11f , 8,12, TennisPlayer::_mt_Attack1, 35, 20, 25, 32, 0, 3,  D3DXToRadian(45), 42 },
        { 2, 1.0f, 1.5f, DamageBase::Type::_WeekDamage, 5, 8, 0.02f, 1, 5, TennisPlayer::_mt_Attack2, 20, 5, 15, 20, 0, 5, D3DXToRadian(8), 42 },
        { 8, 1.0f, 1.5f, DamageBase::Type::_VanishDamage, 8, 16, 0.05f, 1, 6, TennisPlayer::_mt_Attack3, 40, -1, -1, -1, 0, 8, D3DXToRadian(8), 42 },
    };
