...
void TennisState_PlayerControll_Attack::Enter(TennisPlayer* t)
{
    ...
    {
        { 6, 1.9f, 1.5f, DamageBase::Type::_WeekDamage,   18, 25, 0.15f,  8, 12, TennisPlayer::_mt_Attack1, 34, 10, 27, 34, 0, 15, D3DXToRadian(10), 42, 43, 2, 0.1f },
        { 2, 1.9f, 1.5f, DamageBase::Type::_WeekDamage,   4,  5, 0.075f, 1, 5, TennisPlayer::_mt_Attack2, 30, 1, 10, 11, 0, 2, D3DXToRadian(10), 42, 43,     2, 0.55f },
        { 8, 1.6f, 1.5f, DamageBase::Type::_VanishDamage, 18, 19, 1.0f, 15, 15, TennisPlayer::_mt_Attack3, 50, -1, -1, -1, 0, 4, D3DXToRadian(10), 55, 59,   2, 0.8f },
    };
